...
function SignUp({ isOpen, onClose }) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log("Sign Up:", { name, email, password, number });
    onClose();
  };
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-50 px-4">
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md md:max-w-lg lg:max-w-md p-6 md:p-8 relative pointer-events-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
